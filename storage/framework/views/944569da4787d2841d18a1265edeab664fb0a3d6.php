        ...
        <div class="row">
            <div class="col-xs-12">
        		<div class="invoice-title">
        			<h2>Order Summary</h2>
        			<h3 class="pull-right">Order # <?php echo e($order->id); ?></h3>
        		</div>
        		<hr>
        		<div class="row">
        			<div class="col-xs-6">
            			...
            			<?php if($order->other_address != '#'): ?>
        					<?php echo e($order->other_address); ?>
        ...
        <div class="row">
        	<div class="col-md-12">
        		<div class="panel panel-default">
        				...
        				<div class="table-responsive">
        					<table class="table table-condensed">
        						...
        						<tbody>
        							...
        							<?php $__currentLoopData = $my_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        							<tr>
        								<td><?php echo e($item->product_name); ?> </td>
        								<td class="text-center"><?php echo e($item->product_price); ?> BDT</td>
        							...
        							<tr>
        								...
        								<td class="no-line text-right"><?php echo e($price); ?> BDT</td>
        							</tr>
				    ...
				    <a  href="<?php echo e(action('CheckOutController@getOrderComplete')); ?>" class="btn btn-info">Order Completed</a>
