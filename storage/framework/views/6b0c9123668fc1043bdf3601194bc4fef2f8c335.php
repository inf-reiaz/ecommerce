                            ...
                            <div class="col-md-12">
                                <div class="panel profile-wrap">
                                    <header class="panel-heading clearfix">
                                        <h3 class="profile-title pull-left"><?php echo e($user->firstname); ?> <?php echo e($user->firstname); ?></h3>
                                       <div class="pull-right"><a href="<?php echo e(route('alluser')); ?>" class="btn btn-sm btn-info">back</a></div>
                                    </header>
                                    <div class="panel-body row">
                                        <div class="col-md-3">
                                            <div class="profile-thumb">
                                                <img src="<?php echo e($user->user_photo); ?>" alt="<?php echo e($user->firstname); ?>">
                                            </div>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body list-group border-bottom">
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <span class="profile"><?php echo e($user->firstname); ?></span>
                                                    </li>
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <span class="profile"><?php echo e($user->lastname); ?></span>
                                                    </li>
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <span class="profile"><?php echo e($user->username); ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Email:</strong>
                                                        </span>
                                                        <span class="profile"><?php echo e($user->email); ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Contact Number:</strong>
                                                        </span>
                                                        <span class="profile"><?php echo e($user->contact); ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Role:</strong>
                                                        </span>
                                                        <span class="profile"><?php if($user->roles): ?><?php echo e($user->roles->name); ?> <?php endif; ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Country Name:</strong>
                                                        </span>
                                                        <span class="profile"><?php if($user->roles): ?><?php echo e($user->contry->name); ?> <?php endif; ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User City Name:</strong>
                                                        </span>
                                                        <span class="profile"><?php if($user->roles): ?><?php echo e($user->city->name); ?> <?php endif; ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Address :</strong>
                                                        </span>
                                                        <span class="profile"><?php echo e($user->address); ?></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <span class="profile-details-heading">
                                                            <strong>User Parmanent Address :</strong>
                                                        </span>
                                                        <span class="profile"><?php echo e($user->parmanent_address); ?></span>
                                                    </li>
                                                    
                                                    <li class="list-group-item">
                                                        <center>
                                                            <strong>
                                                                <a href="<?php echo e(route('myprofileedit',$user->id)); ?>" class="btn btn-success btn-sm">Edit</a> 
                                                                <a href="<?php echo e(route('alluser')); ?>" class="btn btn-info btn-sm">Back</a>
                                                            </strong>
                                                        </center>
                                                    </li>
