...
<div class="tp-banner-container">
  <div class="tp-banner" style="max-height:300px">
    <ul>
      <!-- SLIDE  -->
      <li data-transition="fade" data-slotamount="7" data-masterspeed="100" data-delay="5000" >
        <!-- MAIN IMAGE -->
        <img src="/public/front/menu3/assets/images/slider.jpg"  alt="slidebg1" data-bgfit="cover" data-bgposition="left center" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
...
data-splitin="chars"
            ...
            data-endeasing="Power3.easeInOut"
            data-captionhidden="on"
            >Welcome To Amar Foods</div>
      </li>
      <!-- SLIDE -->
      <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-delay="5000">
        <!-- MAIN IMAGE -->
        <img src="/public/front/menu3/assets/images/slider2.jpg"  alt="slidebg1" data-bgfit="cover" data-bgposition="left center" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
...
data-splitin="chars"
            ...
            data-endeasing="Power3.easeInOut"
            data-captionhidden="on"
            >Amar Foods Best Foods</div>
      </li>
      <!-- SLIDE -->
      <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-delay="5000" >
        <!-- MAIN IMAGE -->
        <img src="/public/front/menu3/assets/images/slider3.jpg"  alt="slidebg1" data-bgfit="cover" data-bgposition="left center" data-bgrepeat="no-repeat">
        <!-- LAYERS -->
        <div class="tp-caption huge_red skewfromrightshort customout"
            data-x="center"
            data-y="260"
            ...
            data-endeasing="Power3.easeInOut"
            data-captionhidden="on"
            style="z-index:5">Amar Foods </div>
