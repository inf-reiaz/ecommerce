        ...
        <div class="row padding_bottom">
            <div class="col-sm-9">
                <div class="search_bar">
                    <div class="col-sm-9" >
        				<form class="form-inline pull-right form_tab" method="get" action="<?php echo e(action('PublicPagesController@getSearch')); ?>">
                            <div class="form-group">
                                <input class="form-control width_450" type="search" name="item"  value="<?php echo e(request('item')); ?>" placeholder="Search what you want ? like Milk">
                            </div>
                    ...
                    <div class="col-sm-3">
                      <div class=" dropdown">
                        <div class="cart-btn "> <a href="#" class="button adc"   id="MenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <?php echo e(Cart::subtotal()); ?> Taka </a> </div>
                ...
                <div class="phone_number">
                  ...
                  <div class="list2 m-t-18">
                    <ul>
                      ...
                      <li>
                        <a href="<?php echo e(action('PublicPagesController@getProfile')); ?>" class="m_number yellow_bg_round"   data-toggle="tooltip" data-placement="top" title=""> <img src="/public/front/menu3/assets/images/user.png" alt=""> <span class="user_name"> <?php echo e(Auth::user()->firstname); ?> </span></a>
                        
                        <a href="tel:01761429381"  class="yellow_bg_round" data-toggle="tooltip" data-placement="top" title="01761429381"> <sapn class="m_number"> <img src="/public/front/menu3/assets/images/telephone.png"></sapn></a>
...
<nav class="navbar-fixed-top nav_hide">
    ...
    <div class="mobile_menu">
        ...
        <div class="m_cart">
            <a class="mobile_cart search_mobile_button" href=""> <i class="fa fa-shopping-cart"></i> 100 Taka </a>
        </div>
