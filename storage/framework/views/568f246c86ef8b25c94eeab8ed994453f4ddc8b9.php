<div class="col-md-12">
    <?php echo Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('ProductsController@searchIndex')]); ?> 
...
<div class="col-md-12">
    ...
    <?php echo Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('ProductsController@searchByDate')]); ?> 
