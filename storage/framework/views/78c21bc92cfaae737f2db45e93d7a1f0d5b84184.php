            ...
            <div id="content" class="ui-content">
                <div class="ui-content-body">
                    ...
                    <div class="ui-container">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h1 class="page-title"> Block  User</h1>
                            </div>
                            <div class="col-md-4">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table  table-hover general-table">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $blockuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php else: ?>
                                                                    <a href="<?php echo e(route('blockusers',$u->id)); ?>"><span class="label label-info label-warning">Bloc</span></a>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['dashboard',$u->id]]); ?>
