                                                            ...
                                                            <div class="form-group {{ $errors->has('product_photo_input') ? 'has-error' : '' }}">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                  <div class="fileinput-new thumbnail" style="width: 400px; height: 300px;">
                                                                    <img src="{{ ($slider->image) ? $slider->image : 'http://placehold.it/400x300&text=Image+Size+600 x+400 px' }}" alt="...">
                                                                  </div>
                                                    ...
                                                    <div class="form-group {{ $errors->has('slider_position') ? 'has-error' : '' }}">
                                                    
                    					              {!! Form::select('slider_position', 
                    					                  [
                    					                      '1' => 'First Slider', 
                    					                      '2' => 'Secend Slider',
                    					                    ]
                    					               ...
                    					               !!}
                                                        ...
                                                        @if($errors->has('slider_position'))
                                                            <span class="help-block">{{ $errors->first('slider_position') }}</span>
                                                        @endif
                                                    </div>
