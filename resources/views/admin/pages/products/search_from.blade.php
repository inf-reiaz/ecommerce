<div class="col-md-12">
    {!! Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('ProductsController@searchIndex')]) !!} 
...
<div class="col-md-12">
    ...
    {!! Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('ProductsController@searchByDate')]) !!} 
