<div class="col-md-12">
    ...
    {!! Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('AdminOrder@search')]) !!} 
...
<div class="col-md-12">
    ...
    {!! Form::open(['class'=>'row order-srch-form', 'method' =>'post', 'url'=> action('AdminOrder@searchByDate')]) !!} 
