...
Sizes: [
	...
	<head>
		...
		<title>Communication from {{settings()->application_name}} | {{settings()->application_slogan}}</title>
		<style type="text/css">
			/* RESET STYLES */
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						<img src="{{ url('/public/img/settings/logo.png') }}" style="max-width: 300px;"></img>
																						<br>
																						{{settings()->application_name}} | {{settings()->application_slogan}}
																					</div>
																				</td>
																			</tr>
																		</table>
