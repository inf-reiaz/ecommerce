		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
					<ul class="info"> 
						<li><a href="{{ action('PublicPagesController@getAboutUs') }}">About Us</a></li>
						<li><a href="{{ action('PublicPagesController@getContactUs') }}">Contact Us</a></li>
						<li><a href="{{ action('PublicPagesController@getFaq') }}">FAQ's</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Category</h3>
					<ul class="info"> 
						<li><a href="{{ URL::to('/category/offers') }}">SEASONAL OFFERS</a></li>
						<li><a href="{{ URL::to('/category/fish-&-meat') }}">Fish & Meat</a></li>
						<li><a href="{{ URL::to('/category/dry-food') }}">Dry Food</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Profile</h3>
					<ul class="info"> 
					    @auth
						<li><a href="{{ action('PublicPagesController@getUserAccount') }}">My Account</a></li>
					    @else
						<li><a href="{{ action('PublicPagesController@getLogin') }}">Login</a></li>
					    @endauth
